        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-1 text-sm text-[var(--text-muted)]">
              {step === "input" && "أدخل بريدك لتلقّي رمز الدخول"}
              {step === "otp"   && `أدخل الرمز المُرسل إلى ${email}`}
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-3 rounded-xl bg-[var(--bg-page)] border border-[var(--border)] px-4 py-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm font-semibold text-[var(--text-1)] truncate" dir="ltr">{email}</p>
                  </div>
