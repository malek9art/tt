...
export default function AdminLoginPage() {
  ...
  const handleLogin = async () => {
    ...
    // 1. تسجيل الدخول بـ Email + Password
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-brand-950 p-4" dir="rtl"
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-brand-700/50 bg-brand-800/80 p-6 shadow-2xl backdrop-blur">
          ...
          <h2 className="mb-5 text-center text-base font-semibold text-white">
            تسجيل الدخول
          </h2>
          ...
          <div className="mt-5 flex items-center gap-2 rounded-lg bg-brand-900/50 p-3 text-xs text-brand-400">
            ...
            الدخول مقتصر على المسؤولين المسجّلين — لا يمكن إنشاء حسابات إدارية من هنا
          </div>
        </div>
